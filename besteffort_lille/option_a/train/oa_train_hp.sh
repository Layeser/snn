#!/bin/bash
# Option A phase 2 — hp @ 200 epochs, 100% train (HP exportés)


RUN_NAME="cifar10_oa_hp_200ep"
export OUTPUT_DIR="$HOME/internship/snn/HPSTAtten/save/$RUN_NAME"
CONFIG="$HOME/internship/snn/HPSTAtten/config/campaigns/option_a/cifar10_hp_best.yml"
mkdir -p "$OUTPUT_DIR"
