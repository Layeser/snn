...
RUN_NAME="run_test_detr_deformable_single_scale_epoch_50"
...
torchrun \
    ...
    --num_classes 91 \
    --resume "detr_projet/weights/Deformable-DETR/r50_deformable_detr_single_scale_fusion_compatible.pth" \
    --start_epoch 50 \
    --epochs 100 \
